namespace Operations {
    ...
    //by microsoft with the QDK to test our implementation of the qDRIFT protocal described
    //in the paper. Functions borrowed from the microsoft simulation will be clearly labelled
