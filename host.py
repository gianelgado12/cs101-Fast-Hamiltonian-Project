...
if len(arg_list) < 1:
    ...
    # Plotting result of the number of gates generated by each protocal against the precision value used
    # in that run
    ...
    # Plotting result of run time for each protocal against the simulation time used
    # in that run
    ...
    # Plotting result of the number of gates generated by the protocal against the simulation time used
    # in that run
